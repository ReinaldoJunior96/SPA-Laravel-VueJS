<template>
  ...
  <main class="">
    <div>
      <section class=" mt-20">
        <div class="max-w-2xl px-6 text-center mx-auto">
          ...
          <div class="flex items-end justify-center mt-16">
            <img
              class="rounded-full w-4/12 lg:h-52 md:h-48 h-36"
              src="https://noticiasdatv.uol.com.br/media/_versions/noticias/2014/1413919787super_choque_serie_fixed_large.jpg"
              alt=""
            />
          </div>
        </div>
      ...
      <footer class="bg-gradient-to-r from-blue-500 to-purple-600 fixed w-full text-white bottom-0">
        <div class="container mx-auto px-6 py-4">
          <div class="flex justify-between items-center">
            <div>
              <div class="">&copy; Reinaldo Jr</div>
            </div>
...
<script>
import Navigation from "../componentes-compartilhados/Navigation.vue";
export default {
  components: {
    Navigation,
  },
